...
# ${SCRIPT_DIR}/sudo/autodeploy-prestashop.sh ${DEPLOY_NAME} ${BRANCH_NAME} ${GL_USER}
...
. $LIB/prestashop-copy-files-settings.sh $DST_DIR $TMP_DIR
...
# Borrar caches
# @todo es necesario borrar el compilado de smarty?
#rm -rf $DST_DIR/tools/smarty/{cache,compile}
# @todo: you can force the Smarty re-compilation and set to no the use of the cache in Preferences >> Performance.
